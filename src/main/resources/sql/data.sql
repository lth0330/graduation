...
VALUES
    ...
    (11, 1, 'A-B1-005', 'A동 지하주차장 B1 안쪽 구역', 'empty', 2, 1, '샘플 추가'),
    (12, 1, 'A-B1-006', 'A동 지하주차장 B1 안쪽 구역', 'occupied', 2, 2, '입주민 사용 중'),
    (13, 1, 'A-B1-007', 'A동 지하주차장 B1 엘리베이터 근처', 'empty', 2, 3, '샘플 추가'),
    (14, 1, 'A-B1-008', 'A동 지하주차장 B1 전기차 구역', 'disabled', 2, 4, '시설 점검');
